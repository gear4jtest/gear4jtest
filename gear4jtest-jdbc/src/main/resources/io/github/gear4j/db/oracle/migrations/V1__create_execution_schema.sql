...
(
    ...
    assembly_line_id VARCHAR2(255 CHAR) NOT NULL,
...
CREATE INDEX idx_station_log_exec_parent
...
CREATE INDEX idx_ar_assembly_line_start ON assembly_run (assembly_line_id, start_time, id);
CREATE INDEX idx_ar_status_start ON assembly_run (status, start_time, id);
CREATE INDEX idx_ar_start ON assembly_run (start_time, id);
