...
import io.github.gear4jtest.jdbc.service.steps.Step10;
import io.github.gear4jtest.jdbc.service.steps.Step3;
import io.github.gear4jtest.jdbc.service.steps.Step8;
import io.github.gear4jtest.jdbc.service.steps.Step9;
...
public class SimpleChainBuilderDataSourceIT {
    ...
    @Test
    public void assemblyLineWithJdbcPersistence_shouldPersistRunAndStationLogs() {
        // Given
        ...
        var assemblyLineRun = repository.findById(result.getExecution().getId());
        assertThat(assemblyLineRun).isPresent().get()
                .extracting(AssemblyRunRecord::id, AssemblyRunRecord::assemblyLineId, AssemblyRunRecord::inputParams,
