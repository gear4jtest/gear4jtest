 ...
 *
 * <p>Declarative models may initially carry only a {@link ReferencedPipelineTarget}. Runtime-ready
 * models should use either {@link DirectPipelineTarget} or {@link ResolvedPipelineTarget} so execution
 * does not perform loading/resolution work.</p>
 */
