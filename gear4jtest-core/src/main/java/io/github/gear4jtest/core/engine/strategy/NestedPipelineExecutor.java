 ...
 * {@link PipelineCallStationStrategy} to launch a child pipeline as a real
 * nested run.
 *
 * <p>
 ...
 * pipeline runs directly; they should model such calls explicitly with a
 * {@link PipelineCallStation} so validation, lineage, cycle detection and BO
 * traceability remain centralized.
 * </p>
 */
@FunctionalInterface
public interface NestedPipelineExecutor {
    ...
    ExecutionResult<?> executeNested(PipelineCallStation<?, ?> station,
