...
// TODO(all): Create Container1Defition, Container2Definition...
public class FormerContainerDefinition<IN, OUT> extends OperationDefinition<IN, OUT> {

	private List<LineDefinition<?, ?>> subLines;
	private Function<?, ?> func;
	private BiFunction<?, ?, ?> biFunc;

	private FormerContainerDefinition() {
	...
	public static class Builder<IN, OUT> {
		...
		private final FormerContainerDefinition<IN, OUT> managedInstance;

		public Builder() {
			managedInstance = new FormerContainerDefinition<>();
		}
		...
		public FormerContainerDefinition<IN, OUT> build() {
