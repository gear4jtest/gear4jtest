...
// * Cet objet est généralement construit par le DryRunConfigParser à partir
// d'un JSON/YAML.
// */
...
//
// // 2. DEPENDENCY MOCKING : Liste des classes (Opérateurs/Services) à
// remplacer par des Proxies.
...
// private final Map<String, Map<String, Object>> stationParamOverrides = new
// HashMap<>();
//
// // 4. SAFETY : Liste des stations considérées comme dangereuses (ex: écriture
// DB)
// // Si une station est ici ET n'a pas de mock de résultat, le DryRun doit
// échouer.
...
// // Si on mock le résultat, on considère implicitement que l'exécution réelle
// est évitée,
