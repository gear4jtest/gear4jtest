 ...
 *
 * <p>These hooks are observers of station execution. They are invoked by the engine:
 * <ul>
 *   <li>once the station scope has been initialized, before delegate execution,</li>
 *   <li>once the station completion has been normalized.</li>
 * </ul>
 *
 * <p>Implementations are intended for persistence, tracing, metrics, audit, etc.
 */
