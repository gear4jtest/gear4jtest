...
public class StationConfigurationDefinition {
    ...
    // }
    //
    // public List<Class<? extends ProcessingOperationProcessor>>
    // getPostProcessors() {
    ...
    public static class Builder {
        ...
        // public Builder preProcessors(List<ProcessorModel<StepLineElement>>
        // processors) {
        // this.managedInstance.preProcessors.addAll(processors);
        // return this;
        // }

        // public Builder preProcessors(List<Class<? extends
        // ProcessingOperationProcessor>> list) {
        ...
        // public Builder postProcessors(List<Class<? extends
        // ProcessingOperationProcessor>> processors) {
        ...
        // }
        //
        // public UnsafeStepLineElementDefaultConfigurationDefinition.Builder
        // onError(UnsafeOnError<?> onError) {
