...
public enum ExecutionStatus {
    ...
    PAUSED(StatusCategory.ACTIVE), // On considère que "Pause" est un état actif (non-fini)
    ...
    /**
     * Est-ce que ça s'est mal passé ? (Technique ou Timeout)
     * Utile pour le monitoring / alerting.
     */
    ...
    public enum StatusCategory {
         ...
         * Il consomme des ressources (RUNNING) ou attend de le faire (PENDING/PAUSED).
         * Il n'a pas encore produit de résultat final.
         */
        ACTIVE,
         ...
         * Il a un résultat (Succès, Echec ou Stop).
         */
        TERMINAL
    }
}