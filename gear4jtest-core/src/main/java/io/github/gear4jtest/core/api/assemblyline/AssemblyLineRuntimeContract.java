 ...
 * </p>
 */
public final class AssemblyLineRuntimeContract {
    ...
    private AssemblyLineRuntimeContract(InlinePolicy inlinePolicy,
    ...
    public static final class Builder {
        ...
        public AssemblyLineRuntimeContract build() {
            return new AssemblyLineRuntimeContract(inlinePolicy, mandatoryRequirements, providedRequirements);
        }
    }
}
