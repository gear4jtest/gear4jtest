...
// import
// io.github.gear4jtest.core.event.builders.ParameterInjectionEventBuilder.ParameterInjectionEvent;
//
// public class ParameterInjectionEventBuilder implements
// EventBuilder<ParameterContextualData, ParameterInjectionEvent>
// {
//
// private static final String EVENT_NAME = "PARAMETER_INJECTION";
//
// @Override
// public ParameterInjectionEvent buildEvent(UUID uuid, ParameterContextualData
// data) {
