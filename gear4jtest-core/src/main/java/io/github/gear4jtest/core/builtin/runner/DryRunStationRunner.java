...
// * Utilise DryRunConfiguration pour décider s'il faut mocker, bloquer ou exécuter.
// */
...
//
//    public DryRunStationRunner(StrategyRegistry registry, DryRunConfiguration config) {
...
//        // C'est ce qui garantit que les enfants passeront à nouveau par cette méthode run()
