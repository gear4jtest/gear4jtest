...
//
/// **
// * Responsabilité : Fabriquer des instances de StationLogTrace configurées
// pour représenter
// * une exécution simulée (Mock).
// *
// * Pattern : Pure Fabrication / Factory.
// * Cette classe isole la complexité d'initialisation et d'enrichissement des
// métadonnées
...
// */
// StationLogTrace createMock(String stationId, UUID pipelineExecutionId, UUID
// parentOperationId, Object mockData) {
// // 1. Utilisation de l'API standard du modèle (Lifecycle start)
// StationLogTrace log = StationLogTrace.start(pipelineExecutionId, stationId,
// parentOperationId);
//
...
// // Cela permet de distinguer visuellement un mock d'une exécution réelle très
// rapide (1ms)
// log.setEndedAt(log.getStartedAt());
//
// // 4. Enrichissement des métadonnées (Sans modifier la classe
// StationLogTrace)
...
// // On copie la map existante ou on en crée une nouvelle pour éviter les
// NullPointer
// Map<String, Object> context = log.getContext();
// Map<String, Object> newContext = (context != null) ? new HashMap<>(context) :
// new HashMap<>();
//
