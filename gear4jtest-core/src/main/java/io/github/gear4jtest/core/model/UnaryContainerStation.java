...
public class UnaryContainerStation<A> extends ContainerBaseStation<A, A> {
	...
	public static class Builder<A> {
		...
		public Builder<A> withOneLine(AbstractStation<A, A> operationDefinition, Container1Station.Container1DFunction<A, A> function) {
			var branch = new Branch.Builder<A>().withOperation(operationDefinition).build();
			this.managedInstance.pipelines.add(branch);
		...
		public Builder<A> withOneLine(AbstractStation<A, A> operationDefinition, Condition<A> condition, Container1Station.Container1DFunction<A, A> function) {
		...
		public Builder<A> withTwoLines(Branch<A> operationDefinition, Branch<A> operationDefinition2, Container2Station.Container2DFunction<A, A, A> function) {
