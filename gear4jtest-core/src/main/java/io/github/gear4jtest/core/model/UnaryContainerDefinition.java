...
public class UnaryContainerDefinition<A> extends ContainerBaseDefinition<A, A> {
	...
	public static class Builder<A> {
		...
		public Builder<A> withOneLine(AbstractStation<A, A> operationDefinition, Container1Definition.Container1DFunction<A, A> function) {
			var branch = new Branch.Builder<A>().withOperation(operationDefinition).build();
			this.managedInstance.pipelines.add(branch);
		...
		public Builder<A> withOneLine(AbstractStation<A, A> operationDefinition, Condition<A> condition, Container1Definition.Container1DFunction<A, A> function) {
