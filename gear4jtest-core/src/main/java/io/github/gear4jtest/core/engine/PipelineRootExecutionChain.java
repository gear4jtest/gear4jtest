...
final class PipelineRootExecutionChain {
    private final RunnerChainFactory runnerChainFactory;

    PipelineRootExecutionChain(RunnerChainFactory runnerChainFactory) {
    ...
    <IN, OUT> ExecutionResult<OUT> execute(AssemblyLine<IN, OUT> pipeline,
        ...
        RunChain<IN, OUT> chain = () -> PipelineExecutionResultMapper.executeRootStation(pipeline, request, rootRunner,
