 ...
 * @param dispatchedEvents   number of queued events drained by the dispatcher
 *                           thread
 * @param submittedReactions number of reactions successfully submitted to the
 *                           configured executor
 * @param completedReactions number of submitted reactions that completed,
 *                           whether successfully or exceptionally
 * @param droppedReactions   number of reactions dropped before execution,
