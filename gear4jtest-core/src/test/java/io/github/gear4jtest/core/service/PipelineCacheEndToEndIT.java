...
//                        "order:42", new TaskHistoryResult<>(new OrderDto("ORD-42"), Instant.now().plus(Duration.ofMinutes(10)))
//                )
//        );
//
...
//                new JoinSideComputeAndTaskHistoryOperator(joinExecutions, trackingTaskHistoryApi);
//
...
//                SideComputer.<TaskHistoryResult<CustomerDto>>builder("trigger-customer-fetch", "customer-profile")
...
//
//        TriggerSideComputeOperator triggerOperator = new TriggerSideComputeOperator(triggerExecutions);
//        JoinUsingOnlySideComputeOperator joinOperator = new JoinUsingOnlySideComputeOperator(joinExecutions);
//
//        ResourceFactory resourceFactory = new TestResourceFactory(triggerOperator, joinOperator);
//
//        ExecutionContextRegistry executionContextRegistry = new ExecutionContextRegistry();
...
//                SideComputer.<RichCustomerPayload>builder("trigger-customer-fetch", "customer-profile")
...
//
//        // when
//        ExecutionResult<CustomerDto> firstResult = pipelineEngine.execute(pipeline, request);
//        ExecutionResult<CustomerDto> secondResult = pipelineEngine.execute(pipeline, request);
//
//        // then
//        assertThat(firstResult.isSuccess()).isTrue();
//        assertThat(secondResult.isSuccess()).isTrue();
...
//                .<String, String, TriggerSideComputeOperator>processingOperation("trigger-customer-fetch", TriggerSideComputeOperator.class)
//                .build();
//    }
//
//    private static WorkStation<String, FinalOutput> joinStation() {
//        return ElementModelBuilders
//                .<String, FinalOutput, JoinSideComputeAndTaskHistoryOperator>processingOperation("join-sidecompute-and-taskhistory", JoinSideComputeAndTaskHistoryOperator.class)
//                .build();
//    }
//
//    private static WorkStation<String, CustomerDto> joinOnlySideComputeStation() {
//        return ElementModelBuilders
//                .<String, CustomerDto, JoinUsingOnlySideComputeOperator>processingOperation("join-sidecompute-only", JoinUsingOnlySideComputeOperator.class)
//                .build();
//    }
//
//    // --- Operators ---
...
//    }
//
//    static final class JoinSideComputeAndTaskHistoryOperator implements Operator<String, FinalOutput> {
//        private final AtomicInteger executions;
//        private final TaskHistoryApi taskHistoryApi;
//
//        JoinSideComputeAndTaskHistoryOperator(AtomicInteger executions, TaskHistoryApi taskHistoryApi) {
//            this.executions = executions;
...
//    }
//
//    static final class JoinUsingOnlySideComputeOperator implements Operator<String, CustomerDto> {
//        private final AtomicInteger executions;
//
...
//
//        @Override
//        public CustomerDto transform(String input, StationExecutionContext operationExecution) {
//            executions.incrementAndGet();
//
