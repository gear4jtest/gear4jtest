...
class PipelineEngineConfigurationDeepCoverageTest {
    @Test
    void effectiveWorkerConcurrencyConfiguration_shouldStartFromDefaultsAndUseEngineLocalWhenCustomManagerIsProvided() {
        ...
        // When
        WorkerConcurrencyConfiguration configuration = PipelineEngineConfiguration
    ...
    void defaultWorkerConcurrencyManager_shouldUseGlobalOnlyForProcessWideLocking() {
        ...
        // When / Then
        assertThat(PipelineEngineConfiguration.defaultWorkerConcurrencyManager(processWide))
                .isSameAs(WorkerConcurrencyManager.global());
        assertThat(PipelineEngineConfiguration.defaultWorkerConcurrencyManager(local))
                .isNotSameAs(WorkerConcurrencyManager.global());
        assertThat(PipelineEngineConfiguration.defaultWorkerConcurrencyManager(none))
                .isNotSameAs(WorkerConcurrencyManager.global());
    }
}
