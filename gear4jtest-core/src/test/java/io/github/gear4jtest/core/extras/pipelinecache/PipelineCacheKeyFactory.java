...
public final class PipelineCacheKeyFactory {
    ...
    public PipelineCacheKeyFactory(FingerprintStrategy<Object> inputFingerprintStrategy,
    ...
    public PipelineCacheKey create(String pipelineId,
        ...
        return new PipelineCacheKey(pipelineId, pipelineVersion, inputFingerprint, contextFingerprint);
    }
}
