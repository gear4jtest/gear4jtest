...
//
// @Override
// protected void setUp(String input, ExecutionContext context,
...
// var ctx = new ExecutionContext(UUID.randomUUID(), "pipeline-if", null, null,
// execManager, null);
//
...
//
// UnaryIfElseContainerStation.Builder<String> builder =
// new UnaryIfElseContainerStation.Builder<>();
//
// UnaryIfElseContainerStation<String> container =
