...
//
// StepLineElement element = new StepLineElement(operationModel,
// stepLineElementDefaultConfiguration().build(),
// resourceFactory, null);
// UUID id = UUID.randomUUID();
// StepExecution ctx = new StepExecution(new ItemExecution(new
// AssemblyLineExecution(null, id)), new Step1());
// ServiceRegistry.EVENT_TRIGGER_SERVICES.put(id,
// Mockito.mock(EventTriggerService.class));
//
// // When
...
// // Then
// assertThat(((Step1)
// ctx.getOperation()).getA().getValue()).isEqualTo("Value");
//
...
// // Given
// OperationModel<String, Integer> operationModel =
// operation(Step1.class).build();
//
// StepLineElement element = new StepLineElement(operationModel,
// stepLineElementDefaultConfiguration().build(),
// resourceFactory, null);
