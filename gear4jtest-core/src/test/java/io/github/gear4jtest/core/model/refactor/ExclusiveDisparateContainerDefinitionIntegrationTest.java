...
class ExclusiveDisparateContainerDefinitionIntegrationTest {
    ...
    static class ConstantOp extends AbstractOperationDefinition<String, String> {
        ...
        @Override
        protected void setUp(String input, ExecutionContext ctx, OperationExecutionContext op) {}

        @Override
        protected String doExecute(String input, ExecutionContext ctx, OperationExecutionContext op) {
            return out;
        }
    }
