...
public class SomeClassTest {
    ...
    // .step(StepBuilder.newStep(Step4.Step4Map.class).operation(() -> new
    // Step4("a").new Step4Map()).returns("",
    // Void.class))
    // .branches()
    // .branch()
...
//        //@formatter:on
    ...
    // // Given
    //        //@formatter:off
//        io.github.gear4jtest.core.model.generics.recursive.Chain<String, Integer> pipe =
//                io.github.gear4jtest.core.model.generics.recursive.Chain.<String>newChain()
//                    .assemble(
