...
class PipelineExecutionResultMapperTargetedCoverageTest {
    @ParameterizedTest
    ...
    void executeRootStation_shouldMapEveryTerminalStationStatus(StationLogStatus stationStatus,
        ...
        ExecutionResult<String> result = PipelineExecutionResultMapper
    ...
    void executeRootStation_shouldCreateCancellationErrorFromRootLogMessage() {
        ...
        ExecutionResult<String> result = PipelineExecutionResultMapper.executeRootStation(pipeline,
                                                                                          RunRequest.builder()
                                                                                                  .input("input")
                                                                                                  .build(),
    ...
    void finalizeRunFromResult_shouldHandleFatalErrorsNullResultsAndNonExceptionThrowables() {
        ...
        PipelineExecutionResultMapper.finalizeRunFromResult(context, fatal, null, error);
        ...
        PipelineExecutionResultMapper.finalizeRunFromResult(context, nullResult, null, null);
        ...
        assertThat(PipelineExecutionResultMapper.asException(error))
    ...
    private static Stream<Arguments> terminalRootStatuses() {
        return Stream.of(
                         ...
                         Arguments.of(StationLogStatus.RUNNING, ExecutionOutcome.FAILED, ExecutionStatus.FAILED));
    }
    ...
    private static final class TestStation extends AbstractStation<String, String> {
        private TestStation() {
            super("root", StationKind.PROCESSING);
        }
    }
