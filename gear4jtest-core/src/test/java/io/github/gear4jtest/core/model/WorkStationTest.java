...
// WorkerParamsInjector.Parameter<String> prefix =
// WorkerParamsInjector.Parameter.<String>newBuilder().defaultValue("").build();
//
// @Override
...
// WorkerParamsInjector.Parameter.<String>newBuilder().defaultValue("**").build();
//
// // On simule le travail de setUp : on pose directement le transformer dans
// les capabilities
