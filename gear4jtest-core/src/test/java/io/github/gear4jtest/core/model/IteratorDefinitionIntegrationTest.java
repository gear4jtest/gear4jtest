...
//
// OperationParamsInjector.Parameter<Integer> factor =
// OperationParamsInjector.Parameter.<Integer>newBuilder().defaultValue(1).build();
//
// @Override
// public Integer transform(Integer input, ExecutionContext context,
...
// @Test
// void
// iterator_shouldIterateList_applyTransformer_flushPerItem_andPersistEachRecord()
// {
// var execManager = new InMemoryExecutionManager();
// var ctx = new ExecutionContext("iter-p", null, c -> new
// MultiplyTransformer(), execManager);
//
...
// var execManager = new InMemoryExecutionManager();
// var ctx = new ExecutionContext("iter-p2", null, c -> new
// MultiplyTransformer(), execManager);
//
// IteratorDefinition.Builder<Integer, Integer, MultiplyTransformer> builder =
// new IteratorDefinition.Builder<>();
