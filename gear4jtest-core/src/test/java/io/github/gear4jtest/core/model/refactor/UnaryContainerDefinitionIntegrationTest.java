...
class UnaryContainerDefinitionIntegrationTest {
    ...
    static class AppendOp extends AbstractOperationDefinition<String, String> {
        ...
        @Override
        protected void setUp(String input, ExecutionContext c, OperationExecutionContext op) {}

        @Override
        protected String doExecute(String input, ExecutionContext c, OperationExecutionContext op) {
            return input + suffix;
        }
    }
