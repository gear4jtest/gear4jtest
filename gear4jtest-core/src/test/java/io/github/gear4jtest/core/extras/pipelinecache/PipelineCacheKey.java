...
public final class PipelineCacheKey {
    ...
    public PipelineCacheKey(String pipelineId,
    ...
    public boolean equals(Object o) {
        if (this == o)
            return true;
        if (!(o instanceof PipelineCacheKey that))
            return false;
        return pipelineId.equals(that.pipelineId) && pipelineVersion.equals(that.pipelineVersion)
