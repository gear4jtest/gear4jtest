...
public class ResolvedDependency {
    ...
    public ResolvedDependency(String name, String fullyQualifiedName, String simpleClassName, boolean explicitlyMapped) {
        this.name = name;
    ...
    public boolean isExplicitlyMapped() { return explicitlyMapped; }
