...
//
// @Override
// public TypeSpec visit(io.test.gear4jtest.xml.generated.AssemblyLine
// assemblyLine, VisitorContext visitorContext)
// throws ClassNotFoundException {
// Objects.requireNonNull(assemblyLine, "assemblyLine");
// Objects.requireNonNull(visitorContext, "visitorContext");
//
// final String className =
// Names.toTypeName(Names.capitalize(nonEmpty(assemblyLine.getId(), "Assembly"))
// + "Line");
//
// TypeSpec.Builder classBuilder = TypeSpec.classBuilder(className)
// .addJavadoc("Classe générée pour l'assembly line {@code $L}.",
// assemblyLine.getId())
...
// .orElseGet(List::of);
// EnhancedDependencyFieldGenerator depsGen = new
// EnhancedDependencyFieldGenerator(); // TODO: gardez votre impl réelle
...
// }
//
// private void visit(io.test.gear4jtest.xml.generated.AssemblyLine
// assemblyLine, TypeSpec.Builder classBuilder,
// VisitorContext visitorContext) throws ClassNotFoundException {
...
// inputClassName, assemblyLine.getId());
//
...
// }
// ParameterizedTypeName ptn = ParameterizedTypeName.get(AssemblyLine.class,
// inputClassName,
...
// ParameterizedTypeName ptn = ParameterizedTypeName.get(WorkStation.class,
// argumentsTypes[0], argumentsTypes[1]);
//
...
//
// CodeBlock.Builder code = CodeBlock.builder()
// .add("return $T.<$T>iterate($S)\n", ElementModelBuilders.class, lastOut,
// iterator.getId());
//
...
// }
// ParameterizedTypeName ptn = ParameterizedTypeName.get(IteratorStation.class,
// lastOut, visitorContext.getLastOut());
//
...
// }
//
// if (container.getSubLines() != null &&
// !container.getSubLines().getSubLine().isEmpty()) {
...
// ParameterizedTypeName.get(ContainerBaseStation.class, inputType,
// visitorContext.getLastOut());
//
// MethodSpec method = MethodSpec.methodBuilder(methodName)
// .addModifiers(Modifier.PRIVATE)
...
//
// if (ifElse.getConditionalOperations() != null &&
// !ifElse.getConditionalOperations().getConditionalOperation().isEmpty()) {
// for (ConditionalOperationType sub :
...
// var inputType = visitorContext.getLastOut();
// ParameterizedTypeName ptn =
// ParameterizedTypeName.get(UnaryIfElseContainerStation.class, inputType,
// visitorContext.getLastOut());
//
// MethodSpec method = MethodSpec.methodBuilder(methodName)
// .addModifiers(Modifier.PRIVATE)
...
// }
//
// private static String nonEmpty(final String v, final String def) { return (v
// == null || v.isBlank()) ? def : v; }
//
