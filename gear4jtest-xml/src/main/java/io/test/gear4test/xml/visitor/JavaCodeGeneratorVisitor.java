...
//
// @Override
// public TypeSpec visit(AssemblyLine assemblyLine, String className, String
// xmlFileName, VisitorContext visitorContext)
...
//
// for (BaseOperationType operation :
// assemblyLine.getOperations().getOperations()) {
...
// }
//
// private void visit(AssemblyLine assemblyLine, TypeSpec.Builder classBuilder,
...
// .orElseGet(List::of);
// EnhancedDependencyFieldGenerator fieldGenerator = new
// EnhancedDependencyFieldGenerator();
...
// ParameterizedTypeName.get(AssemblyLineDefinition.class, inputClassName,
// visitorContext.getLastOut());
//
...
// }
//
// private void visitOperation(BaseOperationType operation, TypeSpec.Builder
// classBuilder, VisitorContext
// visitorContext) throws ClassNotFoundException {
...
// } else {
// throw new IllegalArgumentException("Type d'opération non supporté: " +
// operation.getClass());
// }
// }
//
// @Override
// public void visit(ProcessingOperationType operation, TypeSpec.Builder
// classBuilder, VisitorContext visitorContext)
// throws ClassNotFoundException {
// String methodName = "createProcessing" + capitalize(operation.getId());
//
// CodeBlock.Builder code = CodeBlock.builder()
// .add("return processingOperation($S, $T.class)\n", operation.getId(),
// ClassName.get(operation.getType().substring(0,
// operation.getType().lastIndexOf(".")),
// operation.getType().substring(operation.getType().lastIndexOf(".") + 1)));
//
...
// .findFirst()
// .orElseThrow(() -> new RuntimeException("Operation class does not implements
// Transformer"));
// Type[] argumentsTypes = operationType.getActualTypeArguments();
// ParameterizedTypeName ptn =
// ParameterizedTypeName.get(ProcessingOperationDefinition.class,
// argumentsTypes[0],
// argumentsTypes[1]);
//
...
//
// @Override
// public void visit(SignalType signal, TypeSpec.Builder classBuilder,
...
// .addJavadoc("Crée le signal '$L' de type $L\n@return le signal configuré",
// signal.getId(), signal.getType())
// .addCode(code.add(" .build();\n").build())
// .build();
//
// classBuilder.addMethod(method);
...
//
// @Override
// public void visit(IteratorType iterator, TypeSpec.Builder classBuilder,
// VisitorContext visitorContext) {
...
//
// ParameterizedTypeName ptn =
// ParameterizedTypeName.get(IteratorDefinition.class, lastOut,
// visitorContext.getLastOut());
//
...
//
// @Override
// public void visit(ContainerType container, TypeSpec.Builder classBuilder,
// VisitorContext visitorContext) {
// String methodName = "createContainer" + capitalize(container.getId());
//
// // Créer la classe interne pour le conteneur
// TypeSpec containerClass = createContainerInnerClass(container,
// visitorContext);
...
//
// @Override
// public void visit(IfElseContainerType ifElse, TypeSpec.Builder classBuilder,
// VisitorContext visitorContext) {
...
//
// @Override
// public void visit(ConfigurationType config, TypeSpec.Builder classBuilder,
// VisitorContext visitorContext) {
// CodeBlock.Builder code = CodeBlock.builder()
...
// .ifPresent(persistence -> code.add("
...
//
// private TypeSpec createIteratorInnerClass(IteratorType iterator,
// VisitorContext visitorContext) {
...
// CodeBlock.Builder code = CodeBlock.builder()
// .add("return $T.<$T>iterate($S)\n", ElementModelBuilders.class,
// visitorContext.getLastOut(), iterator.getId());
//
...
//
// if (iterator.getCollector() != null &&
// iterator.getCollector().getExpression().equals("Collectors.toList()")) {
// visitorContext.setLastOut(new ParameterizedTypeImpl(List.class, null, new
// Type[]{visitorContext.getLastOut()}));
// }
// ParameterizedTypeName ptn =
// ParameterizedTypeName.get(IteratorDefinition.class, inputType,
// visitorContext.getLastOut());
//
...
// }
//
// private static BaseOperationType getBaseOperationType(OperationType
// operation) {
...
// }
//
// private TypeSpec createContainerInnerClass(ContainerType container,
// VisitorContext visitorContext) {
...
// .ifPresentOrElse(
// poolSize -> code.add("return container($L.class,
// $T.newFixedThreadPool($L))\n",
...
//
// ParameterizedTypeName ptn =
// ParameterizedTypeName.get(ContainerBaseDefinition.class, inputType,
// visitorContext.getLastOut());
//
// MethodSpec createMethod = MethodSpec.methodBuilder("create")
// .returns(ptn)
...
// }
//
// private TypeSpec createIfElseInnerClass(IfElseContainerType ifElse,
// VisitorContext visitorContext) {
...
// var inputType = visitorContext.getLastOut();
//
// for (ConditionalOperationType condOp :
// ifElse.getConditionalOperations().getConditionalOperation()) {
...
//
// ParameterizedTypeName ptn =
// ParameterizedTypeName.get(UnvaryingIfElseContainerDefinition.class,
// inputType,
// visitorContext.getLastOut());
//
// MethodSpec createMethod = MethodSpec.methodBuilder("create")
...
// }
//
// private void addOperationToInnerClass(BaseOperationType operation,
// TypeSpec.Builder classBuilder, VisitorContext
// visitorContext) {
// if (operation instanceof ProcessingOperationType processing) {
// try {
// visit(processing, classBuilder, visitorContext);
...
// } else {
// // Pour les opérations complexes imbriquées, on peut créer des sous-classes
// internes
// // ou déléguer à la classe principale selon la complexité
// throw new IllegalArgumentException("Type d'opération non supporté dans classe
// interne: " + operation.getClass());
// }
// }
//
// private void addSignalOperationToInnerClass(SignalType signal,
...
// throw new IllegalArgumentException("Opération sans ID: " +
...
// default -> throw new IllegalArgumentException("Type de signal non supporté: "
// + signalType);
// };
// }
//
...
// code.add(" .parameter($L, $L)\n", supplierParam.getRetriever(),
// supplierParam.getSupplier());
// } else if (param instanceof ContextParameterType contextParam) {
// code.add(" .parameter($L, $L)\n", contextParam.getRetriever(),
// contextParam.getFunction());
// } else {
// throw new IllegalArgumentException("Type de paramètre non supporté: " +
// param.getClass());
// }
// }
// });
// }
//
// private void addErrorHandling(ProcessingOperationType op, CodeBlock.Builder
// code, Type argumentsType) {
...
// }
//
// private void addSingleErrorHandling(Object error, CodeBlock.Builder code,
// Type argumentsType) {
...
// argumentsType, signal, throwableType);
//
// if (condition != null) {
...
// }
//
// private void addConditions(ProcessingOperationType op, CodeBlock.Builder
// code) {
...
// fallback.getExpression());
// });
// }
//
// private void addAccumulatorCollector(IteratorType iterator, CodeBlock.Builder
// code) {
...
// case LIST -> "toList()";
// case SET -> "toSet()";
// default -> throw new IllegalArgumentException("Type d'accumulateur non
// supporté: " + accumulator.getType());
// };
...
// */
// private ParameterizedTypeImpl(final Class<?> rawClass, final Type useOwner,
// final Type[] typeArguments) {
// this.raw = rawClass;
// this.useOwner = useOwner;
// this.typeArguments = Arrays.copyOf(typeArguments, typeArguments.length,
// Type[].class);
// }
//
// /**
