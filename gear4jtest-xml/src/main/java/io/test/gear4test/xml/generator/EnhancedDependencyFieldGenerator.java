...
// }
//
// public List<ClassName> getRequiredImports(Set<ResolvedDependency>
// dependencies) {
// return dependencies.stream()
...
//
/// / String javadocLine = dep.isExplicitlyMapped() / ? String.format("@param %s
// %s", dep.getName(),
/// dep.getDescription()) / : String.format("@param %s %s (type inféré)",
// dep.getName(), dep.getDescription()); /
...
// }
//
// public MethodSpec generateValidationReport(Set<ResolvedDependency>
// dependencies) {
...
// throw new IllegalArgumentException("Type not found for dependency: " +
// dependency.getName(), e);
// }
// }
// }
