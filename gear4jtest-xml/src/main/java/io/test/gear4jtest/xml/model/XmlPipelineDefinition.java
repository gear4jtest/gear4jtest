package io.test.gear4jtest.xml.model;

import java.util.List;

public record XmlPipelineDefinition(
        String id,
        String inputType,
        String outputType,
    ...
    public sealed interface Operation permits ProcessingOperation, IteratorOperation, ContainerOperation, IfElseOperation, SignalOperation {
        String id();
    }
    ...
    public record ProcessingOperation(
            ...
            Transformer fallbackTransformer) implements Operation {}

    public record IteratorOperation(
            String id,
            String inputType,
            String outputType,
            ...
            Operation operation,
            String accumulator,
            String collector) implements Operation {}
    ...
    public record ContainerOperation(
            ...
            String returnsFunction) implements Operation {}

    public record IfElseOperation(
            String id,
            String inputType,
            String outputType,
            List<ConditionalOperation> conditionalOperations,
            ProcessingOperation elseOperation) implements Operation {}

    public record SignalOperation(
            String id,
            String type,
            String inputType,
            Condition condition) implements Operation {}
