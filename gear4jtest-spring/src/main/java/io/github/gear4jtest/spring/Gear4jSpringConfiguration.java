 ...
 *
 * <p>This module intentionally focuses on plain Spring integration only.
...
public class Gear4jSpringConfiguration {
    ...
    @Bean
    public RuntimeExtensionResolver gear4jRuntimeExtensionResolver(
        ...
        List<RuntimeExtension> runtimeExtensions = runtimeExtensionsProvider.orderedStream()
                .sorted(Comparator.comparingInt(RuntimeExtension::getOrder)
    ...
    @Bean
    public PipelineEngine gear4jPipelineEngine(
